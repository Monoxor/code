...
import * as sty from "./PlasmicFooter.module.css"; // plasmic-import: 24wkGHGvgE9HH/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__bKqNs)}
      >
        <div
